  ...
  return (
    <main className="privacy__main">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to AYSE, the software program provided by the Company.
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to AYSE.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        ...
        <li>
          ...
          other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media
          Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to
      ...
      <ul>
        <li>
          <p>By email: ayse.ucla@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a href="https://ayse.onrender.com/ContactUs" rel="external nofollow noopener" target="_blank">
              https://ayse.onrender.com/ContactUs
            </a>
          </p>
        </li>
      </ul>
